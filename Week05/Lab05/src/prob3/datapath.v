...
reg_file u_rf(.clk,.rst_n,.raddr1,.raddr2,.waddr,.wdata(alu_result),.we,.rdata1,.rdata2);

mux2to1_8bit u_mux(.a(rdata2),.b(imm),.sel(src_b_sel),.y(alu_b));

alu_unit u_alu (.a(rdata1),.b(alu_b),.op(alu_op),.y(alu_result),.zero);
